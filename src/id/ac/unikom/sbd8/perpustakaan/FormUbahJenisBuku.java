 ...
 */
public class FormUbahJenisBuku extends javax.swing.JDialog {


    public FormUbahJenisBuku(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormUbahJenisBuku.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FormUbahJenisBuku dialog = new FormUbahJenisBuku(new javax.swing.JFrame(), true);
