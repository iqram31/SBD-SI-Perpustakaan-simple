...
public class FormHistory extends javax.swing.JFrame {
    ...
    public FormHistory(String nama, String hakAkses) {
        initComponents();
        namaUser = nama;
    ...
    private void initComponents() {
        ...
        jLabel6.setText("History Peminjaman dan Pengembalian");
        ...
        btnHistory.setIcon(new javax.swing.ImageIcon(getClass().getResource("/id/ac/unikom/sbd8/perpustakaan/image/btnHistoryClick.png"))); // NOI18N
    ...
    private void btnAnggotaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAnggotaMouseClicked
        ...
        btnAnggota.setIcon(icon);
        dispose();
        FormHistory fa = new FormHistory(namaUser, hakAksesUser);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new FormHistory().setLocationRelativeTo(null);
            }
        });
    }
