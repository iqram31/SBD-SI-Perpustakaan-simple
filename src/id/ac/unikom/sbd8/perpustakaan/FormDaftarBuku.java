 ...
 */
public class FormDaftarBuku extends javax.swing.JDialog {


    public FormDaftarBuku(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FormDaftarBuku dialog = new FormDaftarBuku(new javax.swing.JFrame(), true);
