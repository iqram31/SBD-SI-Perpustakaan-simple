...
public class FormPengembalian extends javax.swing.JFrame {
    ...
    public FormPengembalian(String nama, String hakAkses) {
        initComponents();
        namaUser = nama;
    ...
    private void initComponents() {
        ...
        btnKembalikan = new javax.swing.JLabel();
        ...
        jLabel6.setText("Pengolahan Data Pengembalian");
        ...
        btnPengembalian.setIcon(new javax.swing.ImageIcon(getClass().getResource("/id/ac/unikom/sbd8/perpustakaan/image/btnPengembalianClick.png"))); // NOI18N
        ...
        btnKembalikan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/id/ac/unikom/sbd8/perpustakaan/image/btnKembalikan.png"))); // NOI18N
        btnKembalikan.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                btnKembalikanMouseClicked(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                btnKembalikanMouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                btnKembalikanMouseExited(evt);
            }
        });
    ...
    private void btnAnggotaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAnggotaMouseClicked
        ...
        btnAnggota.setIcon(icon);
        dispose();
        FormPengembalian fa = new FormPengembalian(namaUser, hakAksesUser);
    ...
    private void btnKembalikanMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnKembalikanMouseEntered
        ImageIcon icon = new ImageIcon(getClass().getResource("/id/ac/unikom/sbd8/perpustakaan/image/btnKembalikanHover.png"));
        btnKembalikan.setIcon(icon);
    }//GEN-LAST:event_btnKembalikanMouseEntered

    private void btnKembalikanMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnKembalikanMouseExited
        ImageIcon icon = new ImageIcon(getClass().getResource("/id/ac/unikom/sbd8/perpustakaan/image/btnKembalikan.png"));
        btnKembalikan.setIcon(icon);
    }//GEN-LAST:event_btnKembalikanMouseExited

    private void btnKembalikanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnKembalikanMouseClicked
        ImageIcon icon = new ImageIcon(getClass().getResource("/id/ac/unikom/sbd8/perpustakaan/image/btnKembalikanClick.png"));
        btnKembalikan.setIcon(icon);
        FormTambahPengembalian ftp = new FormTambahPengembalian(this, true);
        ftp.setLocationRelativeTo(null);
        ftp.setVisible(true);
    }//GEN-LAST:event_btnKembalikanMouseClicked
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new FormPengembalian().setLocationRelativeTo(null);
            }
        });
    }
    ...
    private javax.swing.JLabel btnKembalikan;
