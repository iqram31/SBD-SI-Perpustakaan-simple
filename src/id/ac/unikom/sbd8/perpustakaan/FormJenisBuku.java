 ...
 */
public class FormJenisBuku extends javax.swing.JFrame {
    ...
    public FormJenisBuku(String nama, String hakAkses) {
        initComponents();
        namaUser = nama;
    ...
    private void initComponents() {
        ...
        tableJenisBuku = new javax.swing.JTable();
        ...
        tableJenisBuku.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(tableJenisBuku);

        fieldCari.setMargin(new java.awt.Insets(0, 10, 0, 10));

        jLabel6.setFont(new java.awt.Font("Calibri", 1, 24)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(153, 153, 153));
        jLabel6.setText("Pengolahan Jenis Buku");

        btnJenisBuku.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        btnJenisBuku.setIcon(new javax.swing.ImageIcon(getClass().getResource("/id/ac/unikom/sbd8/perpustakaan/image/btnJenisBukuClick.png"))); // NOI18N
    ...
    private void btnAnggotaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAnggotaMouseClicked
        ...
        btnAnggota.setIcon(icon);
        dispose();
        FormJenisBuku fa = new FormJenisBuku(namaUser, hakAksesUser);
    ...
    private void btnTambahMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnTambahMouseClicked
        ...
        btnTambah.setIcon(icon);
        FormTambahJenisBuku ftjb = new FormTambahJenisBuku(this, true);
        ftjb.setLocationRelativeTo(null);
        ftjb.setVisible(true);
    ...
    private void btnUbahMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnUbahMouseClicked
        ...
        FormUbahJenisBuku fujb = new FormUbahJenisBuku(this, true);
        fujb.setLocationRelativeTo(null);
        fujb.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormJenisBuku.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormJenisBuku().setVisible(true);
                new FormJenisBuku().setLocationRelativeTo(null);
            }
        });
    }
    ...
    private javax.swing.JTable tableJenisBuku;
